...
const DEFAULT_MESSAGE = "Hi! I'm interested in JapaCares postpartum services. Can you help me?";
  ...
  return (
    <>
          ...
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
            ...
            <div className="bg-[#ECE5DD] p-5 min-h-[240px] max-h-[300px] overflow-y-auto">
              ...
              <div className="space-y-2 mt-4">
                <p className="text-xs text-gray-500 ml-10 mb-2">Quick options:</p>
      ...
      >
        ...
        {/* Notification dot */}
        {!isOpen && (
          <span className="absolute -top-1 -right-1 w-6 h-6 bg-rose-500 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-lg border-2 border-white animate-bounce">
            1
          </span>
        )}
      </button>
