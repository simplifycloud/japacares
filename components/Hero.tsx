...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-[#FFF8F3] via-[#FFF3EC] to-[#FDE8E4] min-h-screen flex items-center">
      ...
      {/* Soft blurred blobs */}
      <div className="absolute top-[-10%] left-[-5%] w-[500px] h-[500px] bg-rose-200 rounded-full blur-[140px] opacity-40 pointer-events-none" />
      <div className="absolute bottom-[-15%] right-[-10%] w-[600px] h-[600px] bg-amber-200 rounded-full blur-[160px] opacity-40 pointer-events-none" />
      <div className="absolute top-[40%] right-[30%] w-[300px] h-[300px] bg-teal-200 rounded-full blur-[120px] opacity-30 pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 py-20 grid md:grid-cols-2 gap-16 items-center w-full">
        ...
        >
          ...
          <p className="mt-8 text-lg text-gray-600 leading-relaxed max-w-lg">
            Verified Jaapa caregivers offering compassionate postpartum
            support — right at your doorstep. Because every mother deserves
            care as she cares for her baby. 💕
          </p>
        ...
        >
          ...
          >
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-full bg-gradient-to-br from-rose-400 to-pink-500 flex items-center justify-center text-white shadow-md">
