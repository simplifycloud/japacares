        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            >
              ...
              <a href="tel:+918239548307" className="font-serif text-xl font-semibold text-gray-900 hover:text-rose-600 transition mt-1 block">
                +91 8239548307
              </a>
            ...
            >
              ...
              <a href="mailto:support@japacares.com" className="font-serif text-xl font-semibold text-gray-900 hover:text-rose-600 transition mt-1 block">
